...
loans_df["log_probabilty"] = X_probabilities_log    # логарифм вероятности X_probabilities для избегания выхода за машинную точность при слишком малых вероятностей
